@include('encabezado')
        ...
        <div class="col-md-12 white-bg form b-shadow">
            <div class="col-md-12">
                <h1 class="text text-left text-primary">lala</h1>
                <span class="line">
                    ...
                    <div id="carousel-bounding-box">
                        <div class="carousel slide" id="myCarousel" >
                            ...
                            <div class="carousel-inner flex-content" data-toggle="modal" data-target="#myModal" data-interval="false">
                                        ...
                                        <img class="carousel-product-img " src="http://jlaupa.group-celit.com/public_images/206-lala" alt="lala0">
                                    </div>
                                                                </div>
                            <!-- Carousel nav -->
                ...
                <div class="col-xs-12" id="slider-thumbs">
                    ...
                    <ul class="hide-bullets">
                                ...
                                <a class="thumbnail" id="carousel-selector-0" number="0" >
                                    <img  class="mini" src="http://jlaupa.group-celit.com/public_images/206-lala" alt="lala0">
                                </a>
                            </li>
                                            </ul>
                </div>
                ...
                <div class="modal-body producto">
                    <div id="product-carousel-modal" class="carousel slide" data-ride="carousel" data-interval="false">
                        ...
                        <div class="carousel-inner" role="listbox">
                                                        <div class="active item" data-slide-number="0">
                                <img src="http://jlaupa.group-celit.com/public_images/206-lala">
                            </div>
                                                    </div>
                    </div>
                </div>
