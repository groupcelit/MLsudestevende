        ...
        <div class="boxed clearfix">
            <div class="left f-left">
                <h6 class="copyright white light animated" data-animation="fadeIn" data-animation-delay="200">
                    © Copyright 2017 <?php if (2017 <> date("Y")){echo ' - '.(date("Y"));} ?> | <a href="http://ec2-54-233-196-190.sa-east-1.compute.amazonaws.com/" class="logo-link scroll"><span class="semibold">CELIT</span></a>
                </h6>
            </div>
        </div>
    </div>
